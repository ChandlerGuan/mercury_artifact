...
A compiler for auto-distributing tensor computations.
...
### Basic Example to Generate Ring Attention
You can use this command to run the following program: `torchrun --nproc_per_node=8 ./example.py`.
```python
